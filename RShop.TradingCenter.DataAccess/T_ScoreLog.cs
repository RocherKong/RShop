...
namespace RShop.TradingCenter.DataAccess{
 	...
 	///积分日志
 	/// </summary>	
		public class T_ScoreLogDataAccess:DataAccessGeneric<T_ScoreLog>
	{
	    public T_ScoreLogDataAccess(String sqlMapConfigPath = "SqlMap.config")
        ...
        /// <returns></returns>
        public IList<T_ScoreLog> GetList(Hashtable reqParams)
        {
            return GetList<T_ScoreLog>(reqParams);
        }
        
	    /// <summary>
    	/// 分页查询
    	/// </summary>
   		public IList<T_ScoreLog> GetListByPage(Hashtable reqParams, int pageSize, int pageIndex)
        {
        	if (reqParams == null)
            {
            ...
            return GetListByPage<T_ScoreLog>(reqParams);
        }
        ...
        /// <param name="reqParams"></param>
        /// <returns></returns>
        public IList<T_ScoreLog> GetTop(int topNum,Hashtable reqParams)
        {
            return GetTop<T_ScoreLog>(topNum,reqParams);
        }
        #endregion
	}
}