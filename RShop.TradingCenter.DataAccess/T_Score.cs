...
namespace RShop.TradingCenter.DataAccess{
 	...
 	///积分
 	/// </summary>	
		public class T_ScoreDataAccess:DataAccessGeneric<T_Score>
	{
	    public T_ScoreDataAccess(String sqlMapConfigPath = "SqlMap.config")
        ...
        /// <returns></returns>
        public long Insert(T_Score entity)
        {
        ...
        /// <returns></returns>
        public T_Score GetEntity(long Id)
        {
        ...
        /// <returns></returns>
        public IList<T_Score> GetList(Hashtable reqParams)
        {
            return GetList<T_Score>(reqParams);
        }
        
	    /// <summary>
    	/// 分页查询
    	/// </summary>
   		public IList<T_Score> GetListByPage(Hashtable reqParams, int pageSize, int pageIndex)
        {
        	if (reqParams == null)
            {
            ...
            return GetListByPage<T_Score>(reqParams);
        }
        ...
        /// <param name="reqParams"></param>
        /// <returns></returns>
        public IList<T_Score> GetTop(int topNum,Hashtable reqParams)
        {
            return GetTop<T_Score>(topNum,reqParams);
        }
        #endregion
	}
}