...
namespace RShop.TradingCenter.DataAccess{
 	...
 	///产品属性
 	/// </summary>	
		public class T_ProductAttributeDataAccess:DataAccessGeneric<T_ProductAttribute>
	{
	    public T_ProductAttributeDataAccess(String sqlMapConfigPath = "SqlMap.config")
        ...
        /// <returns></returns>
        public IList<T_ProductAttribute> GetList(Hashtable reqParams)
        {
            return GetList<T_ProductAttribute>(reqParams);
        }
        
	    /// <summary>
    	/// 分页查询
    	/// </summary>
   		public IList<T_ProductAttribute> GetListByPage(Hashtable reqParams, int pageSize, int pageIndex)
        {
        	if (reqParams == null)
            {
            ...
            return GetListByPage<T_ProductAttribute>(reqParams);
        }
        ...
        /// <param name="reqParams"></param>
        /// <returns></returns>
        public IList<T_ProductAttribute> GetTop(int topNum,Hashtable reqParams)
        {
            return GetTop<T_ProductAttribute>(topNum,reqParams);
        }
        #endregion
	}
}