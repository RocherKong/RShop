...
namespace RShop.TradingCenter.DataAccess{
 	...
 	///T_City
 	/// </summary>	
		public class T_CityDataAccess:DataAccessGeneric<T_City>
	{
	    public T_CityDataAccess(String sqlMapConfigPath = "SqlMap.config")
        ...
        /// <returns></returns>
        public long Insert(T_City entity)
        {
        ...
        /// <returns></returns>
        public T_City GetEntity(long Id)
        {
        ...
        /// <returns></returns>
        public IList<T_City> GetList(Hashtable reqParams)
        {
            return GetList<T_City>(reqParams);
        }
        
	    /// <summary>
    	/// 分页查询
    	/// </summary>
   		public IList<T_City> GetListByPage(Hashtable reqParams, int pageSize, int pageIndex)
        {
        	if (reqParams == null)
            {
            ...
            return GetListByPage<T_City>(reqParams);
        }
        ...
        /// <param name="reqParams"></param>
        /// <returns></returns>
        public IList<T_City> GetTop(int topNum,Hashtable reqParams)
        {
            return GetTop<T_City>(topNum,reqParams);
        }
        #endregion
	}
}