...
namespace RShop.TradingCenter.DataAccess{
 	...
 	///品牌
 	/// </summary>	
		public class T_BrandDataAccess:DataAccessGeneric<T_Brand>
	{
	    public T_BrandDataAccess(String sqlMapConfigPath = "SqlMap.config")
        ...
        /// <returns></returns>
        public long Insert(T_Brand entity)
        {
        ...
        /// <returns></returns>
        public T_Brand GetEntity(long Id)
        {
        ...
        /// <returns></returns>
        public IList<T_Brand> GetList(Hashtable reqParams)
        {
            return GetList<T_Brand>(reqParams);
        }
        
	    /// <summary>
    	/// 分页查询
    	/// </summary>
   		public IList<T_Brand> GetListByPage(Hashtable reqParams, int pageSize, int pageIndex)
        {
        	if (reqParams == null)
            {
            ...
            return GetListByPage<T_Brand>(reqParams);
        }
        ...
        /// <param name="reqParams"></param>
        /// <returns></returns>
        public IList<T_Brand> GetTop(int topNum,Hashtable reqParams)
        {
            return GetTop<T_Brand>(topNum,reqParams);
        }
        #endregion
	}
}