...
namespace RShop.TradingCenter.Service{
 	...
 	///产品报修
 	/// </summary>	
		public class T_ProductRepairService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ProductRepairDataAccess dao = new T_ProductRepairDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_ProductRepair entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductRepair> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductRepair> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductRepair> GetTop(int topNum,Hashtable requestParams)
        {
