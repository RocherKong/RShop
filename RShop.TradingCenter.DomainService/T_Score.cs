...
namespace RShop.TradingCenter.Service{
 	...
 	///积分
 	/// </summary>	
		public class T_ScoreService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ScoreDataAccess dao = new T_ScoreDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Score entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Score> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Score> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Score> GetTop(int topNum,Hashtable requestParams)
        {
