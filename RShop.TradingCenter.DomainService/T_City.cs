...
namespace RShop.TradingCenter.Service{
 	...
 	///T_City
 	/// </summary>	
		public class T_CityService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_CityDataAccess dao = new T_CityDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_City entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_City> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_City> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_City> GetTop(int topNum,Hashtable requestParams)
        {
