...
namespace RShop.TradingCenter.Service{
 	...
 	///产品
 	/// </summary>	
		public class T_ProductService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ProductDataAccess dao = new T_ProductDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Product entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Product> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Product> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Product> GetTop(int topNum,Hashtable requestParams)
        {
