...
namespace RShop.TradingCenter.Service{
 	...
 	///产品图
 	/// </summary>	
		public class T_ProductImageService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ProductImageDataAccess dao = new T_ProductImageDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_ProductImage entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductImage> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductImage> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductImage> GetTop(int topNum,Hashtable requestParams)
        {
