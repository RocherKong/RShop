...
namespace RShop.TradingCenter.Service{
 	...
 	///T_Invoice
 	/// </summary>	
		public class T_InvoiceService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_InvoiceDataAccess dao = new T_InvoiceDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Invoice entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Invoice> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Invoice> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Invoice> GetTop(int topNum,Hashtable requestParams)
        {
