...
namespace RShop.TradingCenter.Service{
 	...
 	///会员
 	/// </summary>	
		public class T_MemberService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_MemberDataAccess dao = new T_MemberDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Member entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Member> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Member> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Member> GetTop(int topNum,Hashtable requestParams)
        {
