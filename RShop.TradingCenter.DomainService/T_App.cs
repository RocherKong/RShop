...
namespace RShop.TradingCenter.Service{
 	...
 	///应用API
 	/// </summary>	
		public class T_AppService:ServiceBase
	{
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_App entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_App> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_App> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_App> GetTop(int topNum,Hashtable requestParams)
        {
