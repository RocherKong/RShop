...
namespace RShop.TradingCenter.Service{
 	...
 	///T_Favorite
 	/// </summary>	
		public class T_FavoriteService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_FavoriteDataAccess dao = new T_FavoriteDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Favorite entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Favorite> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Favorite> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Favorite> GetTop(int topNum,Hashtable requestParams)
        {
