...
namespace RShop.TradingCenter.Service{
 	...
 	///T_Province
 	/// </summary>	
		public class T_ProvinceService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ProvinceDataAccess dao = new T_ProvinceDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Province entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Province> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Province> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Province> GetTop(int topNum,Hashtable requestParams)
        {
