...
namespace RShop.TradingCenter.Service{
 	...
 	///邀请会员
 	/// </summary>	
		public class T_InviteMemberService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_InviteMemberDataAccess dao = new T_InviteMemberDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_InviteMember entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_InviteMember> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_InviteMember> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_InviteMember> GetTop(int topNum,Hashtable requestParams)
        {
