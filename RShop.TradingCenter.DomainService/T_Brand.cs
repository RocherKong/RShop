...
namespace RShop.TradingCenter.Service{
 	...
 	///品牌
 	/// </summary>	
		public class T_BrandService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_BrandDataAccess dao = new T_BrandDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Brand entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Brand> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Brand> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Brand> GetTop(int topNum,Hashtable requestParams)
        {
