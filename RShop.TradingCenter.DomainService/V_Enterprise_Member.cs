...
namespace RShop.TradingCenter.Service{
 	...
 	///V_Enterprise_Member
 	/// </summary>	
		public class V_Enterprise_MemberService:ServiceBase
	{
		#region Private Field
	
   		private static readonly V_Enterprise_MemberDataAccess dao = new V_Enterprise_MemberDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(V_Enterprise_Member entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<V_Enterprise_Member> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<V_Enterprise_Member> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<V_Enterprise_Member> GetTop(int topNum,Hashtable requestParams)
        {
