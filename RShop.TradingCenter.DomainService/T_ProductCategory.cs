...
namespace RShop.TradingCenter.Service{
 	...
 	///T_ProductCategory
 	/// </summary>	
		public class T_ProductCategoryService:ServiceBase
	{
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_ProductCategory entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductCategory> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductCategory> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductCategory> GetTop(int topNum,Hashtable requestParams)
        {
