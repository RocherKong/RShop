...
namespace RShop.TradingCenter.Service{
 	...
 	///会员关联企业
 	/// </summary>	
		public class Rel_Member_EnterpriseService:ServiceBase
	{
		#region Private Field
	
   		private static readonly Rel_Member_EnterpriseDataAccess dao = new Rel_Member_EnterpriseDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(Rel_Member_Enterprise entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<Rel_Member_Enterprise> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<Rel_Member_Enterprise> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<Rel_Member_Enterprise> GetTop(int topNum,Hashtable requestParams)
        {
