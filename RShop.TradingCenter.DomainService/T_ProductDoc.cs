...
namespace RShop.TradingCenter.Service{
 	...
 	///产品技术文档
 	/// </summary>	
		public class T_ProductDocService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_ProductDocDataAccess dao = new T_ProductDocDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_ProductDoc entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductDoc> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductDoc> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_ProductDoc> GetTop(int topNum,Hashtable requestParams)
        {
