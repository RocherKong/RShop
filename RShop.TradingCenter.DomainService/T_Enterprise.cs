...
namespace RShop.TradingCenter.Service{
 	...
 	///企业
 	/// </summary>	
		public class T_EnterpriseService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_EnterpriseDataAccess dao = new T_EnterpriseDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Enterprise entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Enterprise> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Enterprise> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Enterprise> GetTop(int topNum,Hashtable requestParams)
        {
