...
namespace RShop.TradingCenter.Service{
 	...
 	///T_Country
 	/// </summary>	
		public class T_CountryService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_CountryDataAccess dao = new T_CountryDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_Country entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Country> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Country> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_Country> GetTop(int topNum,Hashtable requestParams)
        {
