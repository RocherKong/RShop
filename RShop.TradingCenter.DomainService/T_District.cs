...
namespace RShop.TradingCenter.Service{
 	...
 	///T_District
 	/// </summary>	
		public class T_DistrictService:ServiceBase
	{
		#region Private Field
	
   		private static readonly T_DistrictDataAccess dao = new T_DistrictDataAccess();     
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(T_District entity)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_District> GetList(Hashtable requestParams)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_District> GetListByPage(Hashtable requestParams, int pageSize, int pageIndex)
        {
        ...
        /// <param name="requestParams"></param>
        /// <returns></returns>
        public IList<T_District> GetTop(int topNum,Hashtable requestParams)
        {
